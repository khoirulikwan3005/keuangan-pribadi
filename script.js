...
/* =========================================================
   21. UPDATE PERSENTASE PENGELUARAN
========================================================= */
...
function updateSpendingProgress(
    ...
    if (
        ...
        descriptionElement.textContent =
            "Pengeluaran masih relatif rendah.";
        ...
        descriptionElement.textContent =
            "Sebagian besar pemasukan sudah digunakan.";
                ...
                ([category, amount]) => `
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                class="transaction-icon expense"
                            >
                                ${getCategoryIcon(
                                    category
                                )}
